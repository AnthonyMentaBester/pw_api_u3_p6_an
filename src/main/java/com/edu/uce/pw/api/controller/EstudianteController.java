...
public class EstudianteController {
	...
	@GetMapping(path = "/hateos/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	public EstudianteTO buscarHateos(@PathVariable Integer id) {
		...
		Link myLink = linkTo(methodOn(EstudianteController.class).buscarPorEstudiante(id)).withRel("susMaterias");
	...
	//http://localhost:8080/API/v1.0/Matricula/estudiantes/6/materias
